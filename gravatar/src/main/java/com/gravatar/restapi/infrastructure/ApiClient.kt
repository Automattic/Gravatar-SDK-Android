...
internal open class ApiClient(
    ...
    internal companion object {
        ...
        internal val apiKey: MutableMap<String, String> = mutableMapOf()
        internal val apiKeyPrefix: MutableMap<String, String> = mutableMapOf()
        internal var username: String? = null
        internal var password: String? = null
        internal var accessToken: String? = null
        internal const val BASE_URL_KEY: String = "com.gravatar.restapi.baseUrl"
